table 51533326 "Imprest Lines"
{
    ...
    fields
    {
        ...
        field(5;"Due Date";Date)
        {
            ...
            begin
                /*RESET;
                SETRANGE(No,ImprestHeader."No.");
                IF FIND ('-') THEN
                  ImprestHeader."External Doc No":="Due Date";
                *///Kim
            ...
            begin
                ...
                if ImprestHeader.FindFirst then
                  begin
                        ...
                        (ImprestHeader.Status=ImprestHeader.Status::Cancelled)or
        ...
        field(482;"No of Days";Decimal)
        {
            ...
            begin
                 getDestinationRateAndAmounts();
                 "Due Date":="Date Issued"+"No of Days";
            end;
        }
        field(483;Quarterly;Boolean)
        {

            trigger OnValidate()
            begin
                ImprestHeader.Get(No);
                //IF ImprestHeader.Status = ImprestHeader.Status::"Pending Approval" THEN ERROR('Document is pending approval and can not be modified');
                  if Quarterly then begin
                    Validate(Amount,Amount/4);
                    Modify(false);
                  end else
                    begin
                    Validate(Amount,Amount * 4);
    ...
    begin
        ...
        if ImprestHeader.FindFirst then
          begin
            ...
            Validate("Shortcut Dimension 3 Code",ImprestHeader."Shortcut Dimension 5 Code");
