table 51533318 "Staff Claims Header"
{
    ...
    fields
    {
        ...
        {
            OptionMembers = "Payment Voucher","Petty Cash",claim;
        }
        ...
        field(482;"Incoming Document Entry No.";Integer)
        {
            ...
            begin
                ...
                if "Incoming Document Entry No." = 0 then
                  ...
                  IncomingDocument.CanReplaceMainAttachment(Rec);
            end;
        }
        field(483;Justification;Text[150])
        {
            DataClassification = ToBeClassified;
        }
        field(484;"Start Date";Date)
        {
            DataClassification = ToBeClassified;
        }
        field(485;"End Date";Date)
        {
            DataClassification = ToBeClassified;
        }
    }
    ...
    var
        CStatus: Code[20];
        PVUsers: Record "Staff Claims Header";
