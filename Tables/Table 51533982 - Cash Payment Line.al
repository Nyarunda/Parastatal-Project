table 51533921 "Cash Payment Line"
{
    //DrillDownPageID = "Travel Authorization Card";
    //LookupPageID = "Travel Authorization Card";
    ...
    fields
    {
        ...
        field(13; "Account No."; Code[20])
        {
            ...
            ELSE
            IF ("Account Type" = CONST(Staff)) "Non Stock Store Line".No;
