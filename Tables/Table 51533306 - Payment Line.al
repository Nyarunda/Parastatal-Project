table 51533306 "Payment Line"
{
    //DrillDownPageID = 39005501;
    //LookupPageID = 39005501;
    ...
    fields
    {
        ...
        field(3; Type; Code[20])
        {
            ...
            begin
                ...
                if PHead.FindFirst then begin
                    Date := PHead.Date;
                    PHead.TestField(PHead."Responsibility Center");
        ...
        field(13; "Account No."; Code[20])
        {
            ...
            var
                ...
                BalErr: Label 'The Customer does not have over-payment';
            begin
                PH.Reset;
                PH.Get(No);
                "Account Name" := '';
                ...
                then
                    case "Account Type" of
                        ...
                        "Account Type"::Customer:
                            begin
                                Cust.Get("Account No.");
                                //added for CAK only proceed if customer owes CAK for REFUND only
                                if (Type = 'REFUND') then begin
        ...
        field(86; "Applies-to Doc. Type"; Enum "Document Types")
        {
        ...
        {
            //TableRelation = Table39004345.Field1 WHERE(Field2 = FIELD("Grant No"),Field50008 = FIELD("Account No."));
        }
        ...
        field(50163; "Inv Doc No"; Code[20])
        {
        }
        ...
        field(56005; "Shortcut Dimension 3 Code"; Code[20])
        {
            CaptionClass = '1,2,3';
        ...
        field(56006; "Shortcut Dimension 4 Code"; Code[20])
        {
            CaptionClass = '1,2,4';
    ...
    begin
        ...
        if PHead.FindFirst then begin
            Date := PHead.Date;
            PHead.TestField(PHead."Responsibility Center");
            PHead.TestField("Global Dimension 1 Code");
            PHead.TestField("Shortcut Dimension 2 Code");
    ...
    var
        ...
        "Date To": Text[30];
        LastDay: Date;
        ImprestReqDet: Record "Payments Header";
        LoadImprestDetails: Record "Payments Header";
        TotAmt: Decimal;
    ...
    var
        CalculationType: Enum "Tax Calculation Type";
    ...
    begin
        ...
        if Amount <> 0 then begin
            ...
            if "VAT 6% Rate" <> 0 then
                "VAT Withhelding Amount" := Round((Amount - "VAT Amount") * ("VAT 6% Rate") / 100, 1, '>');
        end;
