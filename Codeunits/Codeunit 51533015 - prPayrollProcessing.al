codeunit 51533015 prPayrollProcessing
{
                     ...
                     if prTransactionCodes."Is Overtime Allowance" then begin
                        ...
                        ExcessOT := 0;
                          ...
                          //Tax Overtime Excess 50% of BPAY
                            ...
                            TGroup := 'STATUTORIES'; TGroupOrder := 7; TSubGroupOrder := 7;
              ...
              */
               ...
               if blnPaysSSf then begin
                ...
                if HrEmployee.Get(strEmpCode) then begin
                  ...
                  else if (HrEmployee."Social Security Scheme" = HrEmployee."Social Security Scheme"::Old) then begin
            ...
            if "HR-Employee".Get(strEmpCode) then begin
              ...
              BonusNetPay := 0;
                  ...
                  if VitalSetup."Calculate 13th Month On" = VitalSetup."Calculate 13th Month On"::BPay then begin
                    ...
                    Amount13th:=("HR-Employee"."Basic Pay"*Perc*0.01)*(((12-Date2DMY("HR-Employee"."Date Of Join",2)+1))/12)
                    else
                    Amount13th:="HR-Employee"."Basic Pay"*Perc*0.01;
                  end else
    ...
    var
        prPAYEAngola: Record "prPAYE Angola";
        curTempAmount: Decimal;
        KeepCount: Integer;
        Employees: Record "HR-Employee";
        Posting: Record "prEmployee Posting Group";
